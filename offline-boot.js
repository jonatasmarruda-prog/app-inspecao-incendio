...
async function load(){for(let i=0;i<scripts.length;i++){try{await add(scripts[i],i)}catch(e){console.warn('Falha ao carregar',e)}}bind();setTimeout(bind,500);setTimeout(bind,1500);setTimeout(bind,3000)}
