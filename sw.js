const CACHE='inspecao-sst-v7';
const ASSETS=['./','./index.html','./sst-modulos.js','./sst-repair-loader.js','./compartilhar-relatorio.js','./editar-relatorio.js','./abnt-relatorio.js','./manifest.json','./sw.js','./offline-boot.js'];
